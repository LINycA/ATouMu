...
INFO_COMPLETION_SUCCESS = trans_res({"ret":200,"msg":"音乐信息刮削模块启动成功"})
INFO_COMPLETION_FAILED = trans_res({"ret":201,"msg":"音乐信息刮削模块启动失败"})
KEEPALIVE = trans_res({"id":"keepalive","response":"ok"})